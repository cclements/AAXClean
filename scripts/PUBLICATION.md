...
The parser receipt gate also requires execution of the new output-admission, AAC
preroll, encoder-timing, sync, filter/reader-failure and E-AC-3 regression classes.
Missing an entire owned regression class cannot leave only the older suite green.
