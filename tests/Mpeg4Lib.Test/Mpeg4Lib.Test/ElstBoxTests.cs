...
public class ElstBoxTests
{
	...
	[TestMethod]
	public void SingleEdit_TreatsAnEmptyListAsNoPresentationEdit()
	{
		Assert.IsNull(CreateElst().SingleEdit);
	}

	[TestMethod]
	public void SingleEdit_RejectsEveryUnsupportedNonEmptyShape()
	{
	...
	[TestMethod]
	public void PresentedMediaDuration_ClampsOnlySubTickQuantizationOvershoot()
	{
		var edit = new ElstBox.EditEntry(489_500, 0);

		Assert.AreEqual(21_586_944L, ElstBox.GetPresentedMediaDuration(
			edit, mediaDuration: 21_586_944, movieTimescale: 1000, mediaTimescale: 44_100));
		Assert.ThrowsExactly<InvalidDataException>(() => ElstBox.GetPresentedMediaDuration(
			edit, mediaDuration: 21_586_905, movieTimescale: 1000, mediaTimescale: 44_100));
	}
